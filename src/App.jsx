...
const App = () => {
  ...
  return (
    <div className="min-h-screen flex flex-row transition-colors duration-300 bg-white text-black dark:bg-[#13131a] dark:text-white">
      <div className="relative mr-10 hidden sm:flex">
        <Sidebar />
      </div>

      <div className="mx-auto max-w-[1280px] flex-1 max-sm:w-full sm:pr-5 p-4">
        <Navbar />
